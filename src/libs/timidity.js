export const LibTimidity = (function () {
  var _scriptDir =
  ...
  return function (LibTimidity) {
    ...
    var wasmBinaryFile = "../src/libs/libtimidity.wasm";
    ...
    var _mid_exit = (Module["_mid_exit"] = function () {
      return (_mid_exit = Module["_mid_exit"] = Module["asm"]["v"]).apply(
        null,
        arguments
      );
    });
    var _mid_init = (Module["_mid_init"] = function () {
      return (_mid_init = Module["_mid_init"] = Module["asm"]["w"]).apply(
        null,
        arguments
      );
    });
